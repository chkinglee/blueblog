...
type T interface {
	...
	AppendRabbitMQ(rabbitmq *RabbitMQ) *Trace
...
type Trace struct {
	...
	RabbitMQ           []*RabbitMQ `json:"rabbit_mq"`            // 执行的 RabbitMQ 信息
...
// AppendRabbitMQ 追加 RabbitMQ
func (t *Trace) AppendRabbitMQ(rabbitmq *RabbitMQ) *Trace {
	if rabbitmq == nil {
		return t
	}
	...
	t.RabbitMQ = append(t.RabbitMQ, rabbitmq)
	return t
}
